...
class HomeFragment : Fragment(), View.OnClickListener, DemoAdapter.DemoAdapterOnClickListener {
    ...
    private fun getRecentProduct() {
        ...
        binding.content.listOfRecentProduct.adapter = DemoAdapter(suggestedProductList, this)
    }

    private fun getSpecialtyProduct() {
        binding.content.listOfSpecialtyProduct.adapter = DemoAdapter(suggestedProductList, this)
    }

    private fun getOcopProduct() {
        binding.content.listOfOcopProduct.adapter = DemoAdapter(suggestedProductList, this)
    }

    private fun getFlashSaleProduct() {
        binding.content.listOfFlashSale.adapter = DemoAdapter(suggestedProductList, this)
    }
