...
import com.example.argiecommerce.databinding.FragmentTayNguyenBinding
import com.example.argiecommerce.model.Product


class TayNguyenFragment : Fragment(), View.OnClickListener, DemoAdapter.DemoAdapterOnClickListener {
    private var _binding: FragmentTayNguyenBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTayNguyenBinding.inflate(inflater, container, false)

        recyclerView = binding.tayNguyenRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.tayNguyenRecyclerView.adapter = DemoAdapter(dataList, this)
    }
