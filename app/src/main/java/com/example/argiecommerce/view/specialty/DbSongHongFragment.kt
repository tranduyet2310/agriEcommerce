...
class DbSongHongFragment : Fragment(), View.OnClickListener,
    DemoAdapter.DemoAdapterOnClickListener {
    private var _binding: FragmentDbSongHongBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDbSongHongBinding.inflate(inflater, container, false)

        recyclerView = binding.dbSHRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.dbSHRecyclerView.adapter = DemoAdapter(dataList, this)
    }
