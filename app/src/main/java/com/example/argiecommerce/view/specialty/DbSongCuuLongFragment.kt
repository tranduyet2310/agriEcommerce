...
import com.example.argiecommerce.databinding.FragmentDbSongCuuLongBinding
import com.example.argiecommerce.model.Product


class DbSongCuuLongFragment : Fragment(), View.OnClickListener,
    DemoAdapter.DemoAdapterOnClickListener {
    private var _binding: FragmentDbSongCuuLongBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDbSongCuuLongBinding.inflate(inflater, container, false)

        recyclerView = binding.dbSCLRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.dbSCLRecyclerView.adapter = DemoAdapter(dataList, this)
    }
