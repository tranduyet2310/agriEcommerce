...
import com.example.argiecommerce.databinding.FragmentBacTrungBoBinding
import com.example.argiecommerce.model.Product


class BacTrungBoFragment : Fragment(), View.OnClickListener,
    DemoAdapter.DemoAdapterOnClickListener {
    private var _binding: FragmentBacTrungBoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBacTrungBoBinding.inflate(inflater, container, false)

        recyclerView = binding.bTBRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.bTBRecyclerView.adapter = DemoAdapter(dataList, this)
    }
