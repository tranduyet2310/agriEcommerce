...
class BacTrungBoFragment : Fragment(){
    ...
    private var bacTrungBoId: Long = 0L
    ...
    private fun setupAreaData() {
        binding.titleArea.text = requireContext().resources.getString(R.string.bac_trung_bo_name)
        binding.imageArea.setImageResource(R.drawable.bac_trung_bo)
        binding.areaInfo.text = requireContext().resources.getString(R.string.bac_trung_bo)
    }
