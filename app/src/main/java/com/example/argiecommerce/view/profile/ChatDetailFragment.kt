...
class ChatDetailFragment : Fragment() {
    ...
    private lateinit var supplierUid: String
    ...
    override fun onCreateView(
        ...
        supplierUid = navArgs.userUid
        firebaseUser = auth.currentUser

        setupReceiverInfo()
        setupSelectImageEvent()
        seenMessage(supplierUid)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imgSendMessage.setOnClickListener {
            ...
            if (message.equals("")){
                ...
                notify = true
                sendMessageToSupplier(firebaseUser!!.uid, supplierUid, message)
            }
            ...
            if (imageUri != null){
                ...
                uploadTask.continueWithTask<Uri?>(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if (task.isSuccessful){
                        ...
                        messageHashMap["receiver"] = supplierUid
                        ...
                        ref.child(Constants.CHAT).child(messageId!!).setValue(messageHashMap)
                            .addOnCompleteListener { tasks ->
                                if (tasks.isSuccessful){
                                    ...
                                    val references = firebaseDatabase.reference.child(Constants.USER)
                                    ...
                                    references.addValueEventListener(object : ValueEventListener{
                                        override fun onDataChange(snapshot: DataSnapshot) {
                                            ...
                                            if (notify)
                                            {
                                                sendNotification(supplierUid, user!!.name, "Gửi một hình ảnh")
                                            }
                                            notify = false
                                        }
    ...
    private fun setupReceiverInfo() {
        ...
        reference.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                retrieveMessage(firebaseUser!!.uid, supplierUid, user.profileImage)
            }
    ...
    private fun sendMessageToSupplier(senderUid: String, receiverUid: String, message: String) {
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful){
                    ...
                    chatListReference.addListenerForSingleValueEvent(object : ValueEventListener{
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if(!snapshot.exists()){
                                chatListReference.child("id").setValue(supplierUid)
                            }
...
//                    messageAdapter = MessageAdapter(this@ChatDetailFragment.requireContext(), (chatList as ArrayList<Chat>), imageUrl!!)
