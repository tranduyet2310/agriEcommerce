...
import com.example.argiecommerce.databinding.FragmentBacBoBinding
import com.example.argiecommerce.databinding.FragmentSpecialtyBinding
import com.example.argiecommerce.model.Product


class BacBoFragment : Fragment(), View.OnClickListener, DemoAdapter.DemoAdapterOnClickListener {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBacBoBinding.inflate(inflater, container, false)

        recyclerView = binding.bacBoRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.bacBoRecyclerView.adapter = DemoAdapter(dataList, this)
    }
