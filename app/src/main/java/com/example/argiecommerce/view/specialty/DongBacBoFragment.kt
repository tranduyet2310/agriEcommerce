...
import com.example.argiecommerce.databinding.FragmentDongBacBoBinding
import com.example.argiecommerce.model.Product


class DongBacBoFragment : Fragment(), View.OnClickListener, DemoAdapter.DemoAdapterOnClickListener {
    private var _binding: FragmentDongBacBoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDongBacBoBinding.inflate(inflater, container, false)

        recyclerView = binding.dBBRecyclerView
...
//        navController = Navigation.findNavController(view)
    ...
    private fun getSampleData() {
        ...
        binding.dBBRecyclerView.adapter = DemoAdapter(dataList, this)
    }
