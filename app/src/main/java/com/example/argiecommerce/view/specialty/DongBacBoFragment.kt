...
class DongBacBoFragment : Fragment() {
    ...
    private var dongBacBoId: Long = 0L
    ...
    private fun setupAreaData() {
        binding.titleArea.text = requireContext().resources.getString(R.string.dong_bac_bo_name)
        binding.imageArea.setImageResource(R.drawable.dong_bac_bo)
        binding.areaInfo.text = requireContext().resources.getString(R.string.dong_bac_bo)
    }
